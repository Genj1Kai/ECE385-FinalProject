...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../finalproj_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is finalproj_soc
SOPC_NAME := finalproj_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1609567499
SOPC_SYSID_FLAG += --timestamp=1609567499
ELF_PATCH_FLAG  += --timestamp 1609567499
